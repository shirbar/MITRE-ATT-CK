...
# Mitre CTI measure tool
# This function compare the result of mitre cti to the result of the other 2
...
# Event List measure tool
# This function compare the result of event list to the result of the other 2
